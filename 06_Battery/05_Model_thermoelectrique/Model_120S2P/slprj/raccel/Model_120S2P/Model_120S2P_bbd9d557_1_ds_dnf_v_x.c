...
#include "ne_ds.h"
#include "Model_120S2P_bbd9d557_1_ds_dnf_v_x.h"
...
int32_T Model_120S2P_bbd9d557_1_ds_dnf_v_x ( const NeDynamicSystem * sys ,
...
out = t2 -> mDNF_V_X ; for ( b = 0 ; b < 593 ; b ++ ) { t0 [ b ] =
_cg_const_1 [ b ] ; } for ( b = 0 ; b < 593 ; b ++ ) { out . mX [ b ] = t0 [
b ] ; } ( void ) sys ; ( void ) t2 ; return 0 ; }
